  ...
  return (
    <div className="offcanvas offcanvas-start offcanvas-width" tabIndex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <a href="#" className="btn btn-light btn-sidebar-offcanvas mb-2 d-flex align-items-center">
        <img src="data/sea turtle.PNG" alt="Subscription 1" className="rounded-circle me-2" width="32" height="32" />
        <span>Subscription 1</span>
      </a>
    </li>
    <li className="nav-item">
      <a href="#" className="btn btn-light btn-sidebar-offcanvas mb-2 d-flex align-items-center">
        <img src="data/sea turtle.PNG" alt="Subscription 2" className="rounded-circle me-2" width="32" height="32" />
        <span>Subscription 2</span>
      </a>
    </li>
    <li className="nav-item">
      <a href="#" className="btn btn-light btn-sidebar-offcanvas mb-2 d-flex align-items-center">
        <img src="data/sea turtle.PNG" alt="Subscription 3" className="rounded-circle me-2" width="32" height="32" />
